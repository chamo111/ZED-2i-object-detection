        ...
        if zed.grab(runtime_params) == sl.ERROR_CODE.SUCCESS:
            ...
            if zed.grab(runtime_params) == sl.ERROR_CODE.SUCCESS:
                ...
                if math.isfinite(point_cloud_value[2]):
                    ...
                    print(f"\n Distance to Camera at {{{x};{y}}}: {distance}")
                else : 
                    print(f"\n The distance can not be computed at {{{x};{y}}}")            
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='boundingbox_yolov8_ood.pt', help='model.pt path(s)')
